...
public class FactorialTest {
    ...
    private void bigFactorials(Function<Integer, BigInteger> factorial) {
        ...
        assertEquals(n + "! should be " + factorialNumber + ".",
                new BigInteger(factorialNumber), factorial.apply(n));
        n = 70;
        factorialNumber = "11978571669969891796072783721689098736458938142546425857555362864628009582789845319680000000000000000";
        assertEquals(n + "! should be " + factorialNumber + ".",
                new BigInteger(factorialNumber), factorial.apply(n));
        n = 80;
        factorialNumber = "71569457046263802294811533723186532165584657342365752577109445058227039255480148842668944867280814080000000000000000000";
        assertEquals(n + "! should be " + factorialNumber + ".",
                new BigInteger(factorialNumber), factorial.apply(n));
        n = 90;
